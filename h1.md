...
## Kaikkien TCP-porttien skannaus, kun SSH on päällä (localhost)
...
## Laaja porttiskannaus SSH (localhost)
...
## Porttiskannauksien tuloksen ero verrattuna Apache 2:hteen (localhost)

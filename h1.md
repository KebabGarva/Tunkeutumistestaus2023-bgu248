...
## Noin 1000:n tyypillisen TCP-portin skannaus (localhost)
...
Tehtävänanto ei tarkentanut, että palomuurin asetuksia pitäisi lähtemään muokkaamaan, joten jätän sen toistaiseksi väliin.

## Kaikkien TCP-porttien skannaus (localhost)

**Käyttöjärjestelmä: Kali 2024.1**

Muutin mieleni melkein välittömästi, koska halusin henkilökohtaisesti lähteä kokeilemaan, miltä näyttää porttiskannaus porttien ollessa auki. Irroitin virtuaalikoneen verkosta ennen tehtävän tekoa ilmiselvistä tietoturvallisista syistä.

![image](https://github.com/KebabGarva/Tunkeutumistestaus2024-bgu248/assets/89390996/6cebc976-4b9e-48da-8811-ca1ebf621d32)


Suoritin seuraavan komennon avatakseni kaikki TCP-portit:




## Laaja porttiskannaus (localhost)

**Käyttöjärjestelmä: Kali 2024.1**


## Porttiskannauksien tuloksien ero eri daemonien olevan aktiivisia (localhost)
